...
if (!$result)
    die("Erro ao buscar sugestões: " . $conn->error);
?>
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="../../../back_end/cadastro/cadastro_livro.php" enctype="multipart/form-data"
            id="formCadastro">
            ...
            <textarea name="descricao" id="descricao" rows="4" cols="50" maxlength="9999"
                placeholder="Digite até 9999 caracteres" required></textarea><br>
        ...
        <?php if ($result->num_rows > 0): ?>
            <table>
                ...
                <?php while ($livro = $result->fetch_assoc()): ?>
                    <tr>
                        <td>
                            <input type="radio" name="selecionado" data-id="<?= $livro['ID_Livro'] ?>"
